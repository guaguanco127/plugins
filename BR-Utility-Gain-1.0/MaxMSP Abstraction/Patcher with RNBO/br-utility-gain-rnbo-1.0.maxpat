...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.0, 134.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 178.0, 71.0, 22.0 ],
					"text" : "Decibels $1"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 83.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 220.0, 93.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 511.0, 45.0, 45.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 502.0, 14.0, 321.0, 22.0 ],
									"text" : "in 3 @comment Decibels @min -72. @max 35. @default 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 413.0, 619.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
,
					"patching_rect" : [ 563.0, 186.0, 132.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 414.0, 328.0, 48.0, 136.0 ],
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 409.0, 73.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 606.0, 83.0, 50.0, 22.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 445.0, 97.0, 179.0, 37.0 ],
...
,
									"text" : "param Decibels @minimum -72. @maximum 35.",
									"varname" : "Decibels"
								}
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 3 @comment Decibels @min -72. @max 35.",
														"id" : "obj-8",
														"outlettype" : [ "" ],
...
,
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 127.0, 141.0, 132.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 240.0, 278.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 106.0, 278.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 248.0, 30.0, 178.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
, 							{
						...
						"export_config" : 						{
							"vst-au-export" : 							{
								"vst-au-export-ins" : 								{
									"plugin_name" : "BR-Utility-Gain-1",
									"plugin_manufacturer_name" : "guaguanco127",
									"plugin_manufacturer_code" : "R001"
								}
...
,
					"patching_rect" : [ 46.0, 197.0, 43.0, 22.0 ],
					"rnboattrcache" : 					{
						"Decibels" : 						{
							"label" : "Decibels",
							"isEnum" : 0,
...
, 			{
				...
				"patcherrelativepath" : "../../Documents/Max 8/Externals/Virtual Sound Macros/media/sound files",
				"type" : "WAVE",
				"implicit" : 1
			}
 ],
